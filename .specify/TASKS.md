...
5. Docs: add platform-specific notes for SecureStorage and recommended SDK versions. [owner: TBD] [status: todo]

How to pick a task
- Use `.specify/PLAN.md` to see milestone alignment. Update this file when starting or completing work.
